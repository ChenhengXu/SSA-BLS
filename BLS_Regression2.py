...
def bls_regression2(train_x,train_y,test_x,test_y,s,C,NumFea,NumWin,NumEnhan):
    ...
    RR2 = metrics.r2_score(NetoutTrain, train_y)
...
#%% Calculate the testing accuracy
    ...
    return test_RR2,test_ERR,test_MAPE,train_RR2,train_ERR,train_MAPE,NetoutTest,test_y
